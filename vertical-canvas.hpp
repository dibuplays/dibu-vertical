...
private:
	...
	QIcon recordActiveIcon = QIcon(":/dibu/media/recording.svg");
	QIcon recordInactiveIcon = QIcon(":/dibu/media/record.svg");
	...
	QIcon streamActiveIcon = QIcon(":/dibu/media/streaming.svg");
	QIcon streamInactiveIcon = QIcon(":/dibu/media/stream.svg");

	QIcon replayActiveIcon = QIcon(":/dibu/media/backtrack_on.svg");
	QIcon replayInactiveIcon = QIcon(":/dibu/media/backtrack_off.svg");

	QIcon virtualCamActiveIcon = QIcon(":/dibu/media/virtual_cam_on.svg");
	QIcon virtualCamInactiveIcon = QIcon(":/dibu/media/virtual_cam_off.svg");
